            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  name="password"
                  placeholder="••••••••"
                  className="w-full rounded-md border border-slate-700 bg-slate-900/70 px-3 py-2 pr-14 text-xs text-slate-50 placeholder:text-slate-500 focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500"
                  onChange={handleChange}
                  required
                />
                <button
